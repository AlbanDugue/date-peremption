...
class __TwigTemplate_e3e942ce8c1cf552e9362d0cf9e217ed4ed4ac5f1cdc19041beb5fafa9b36937 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div id=\"registerForm\">
        ...
        echo "
                ";
        // line 17
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 17, $this->source); })()), "username", [], "any", false, false, false, 17), 'row', ["label" => "Pseudo"]);
        // line 19
        echo "
                ";
        // line 20
...
{% block title %}S'inscrire {{ parent() }}{% endblock %}
...
{% endblock %}
", "registration/register.html.twig", "C:\\wamp64\\www\\PROJET-PERSO\\date-peremption\\templates\\registration\\register.html.twig");
    }
}
