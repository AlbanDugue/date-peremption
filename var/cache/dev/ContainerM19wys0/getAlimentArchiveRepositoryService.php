 ...
 */
class getAlimentArchiveRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AlimentArchiveRepository' shared autowired service.
     *
     * @return \App\Repository\AlimentArchiveRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AlimentArchiveRepository.php';

        return $container->privates['App\\Repository\\AlimentArchiveRepository'] = new \App\Repository\AlimentArchiveRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
